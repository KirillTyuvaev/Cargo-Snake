class Snake {
    ...
    async loadImages() {
        ...
        this.headImage.onerror = () => console.error('Ошибка загрузки snake_head.png');
        this.headImage.onload = () => console.log('snake_head.png загружен успешно');
        this.headImage.src = 'snake_head.png';
        
        this.bodyImage = new Image();
        this.bodyImage.onerror = () => console.error('Ошибка загрузки snake_body.png');
        this.bodyImage.onload = () => console.log('snake_body.png загружен успешно');
...
class Food {
    ...
    async loadImages() {
        ...
        this.foodImage.onerror = () => console.error('Ошибка загрузки food.png');
        this.foodImage.onload = () => console.log('food.png загружен успешно');
        this.foodImage.src = 'food.png';
        
        this.grapeImage = new Image();
        this.grapeImage.onerror = () => console.error('Ошибка загрузки Grape.png');
        this.grapeImage.onload = () => console.log('Grape.png загружен успешно');
...
class Game {
    constructor() {
        ...
        // Добавляем обработчик клавиш и предотвращаем прокрутку
        document.addEventListener('keydown', (event) => {
            if (['ArrowUp', 'ArrowDown', 'ArrowLeft', 'ArrowRight', 'Space'].includes(event.code)) {
                event.preventDefault(); // Предотвращаем прокрутку только для нужных клавиш
            }
